...
func (x *GetPaymentItemReq) Reset() {
	*x = GetPaymentItemReq{}
...
func (x *GetPaymentItemReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPaymentItemReq) ProtoMessage() {}

func (x *GetPaymentItemReq) ProtoReflect() protoreflect.Message {
	mi := &file_checkout_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPaymentItemReq.ProtoReflect.Descriptor instead.
func (*GetPaymentItemReq) Descriptor() ([]byte, []int) {
	return file_checkout_proto_rawDescGZIP(), []int{4}
}

func (x *GetPaymentItemReq) GetUserId() uint32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetPaymentItemReq) GetOrderId() string {
	if x != nil {
		return x.OrderId
	}
	return ""
...
type GetPaymentItemResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CreditCardNumber          string `protobuf:"bytes,1,opt,name=CreditCardNumber,proto3" json:"CreditCardNumber,omitempty"`
	CreditCardCVV             int32  `protobuf:"varint,2,opt,name=CreditCardCVV,proto3" json:"CreditCardCVV,omitempty"`
...
func (x *GetPaymentItemResp) Reset() {
	*x = GetPaymentItemResp{}
	mi := &file_checkout_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPaymentItemResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPaymentItemResp) ProtoMessage() {}

func (x *GetPaymentItemResp) ProtoReflect() protoreflect.Message {
	mi := &file_checkout_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPaymentItemResp.ProtoReflect.Descriptor instead.
func (*GetPaymentItemResp) Descriptor() ([]byte, []int) {
	return file_checkout_proto_rawDescGZIP(), []int{5}
}

func (x *GetPaymentItemResp) GetCreditCardNumber() string {
	if x != nil {
		return x.CreditCardNumber
	}
	return ""
...
func (x *GetPaymentItemResp) GetCreditCardCVV() int32 {
	if x != nil {
		return x.CreditCardCVV
	}
	return 0
...
func (x *GetPaymentItemResp) GetCreditCardExpirationYear() int32 {
	if x != nil {
		return x.CreditCardExpirationYear
	}
	return 0
...
func (x *GetPaymentItemResp) GetCreditCardExpirationMonth() int32 {
	if x != nil {
		return x.CreditCardExpirationMonth
	}
	return 0
...
func (x *GetPaymentItemResp) GetOrderID() string {
	if x != nil {
		return x.OrderID
	}
	return ""
...
func (x *GetPaymentItemResp) GetTransactionID() string {
	if x != nil {
		return x.TransactionID
	}
	return ""
...
func (x *GetPaymentItemResp) GetUserID() uint32 {
	if x != nil {
		return x.UserID
	}
	return 0
...
var file_checkout_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x7a, 0x69, 0x70, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xde, 0x01, 0x0a,
	...
	0x73, 0x73, 0x12, 0x39, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x63, 0x61, 0x72,
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f,
	0x75, 0x74, 0x2e, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x43, 0x61, 0x72, 0x64, 0x49, 0x6e, 0x66,
	...
	0x72, 0x65, 0x64, 0x69, 0x74, 0x43, 0x61, 0x72, 0x64, 0x45, 0x78, 0x70, 0x69, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x4d, 0x6f, 0x6e, 0x74, 0x68, 0x22, 0x45, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a,
	...
	,
	...
	0x63, 0x6b, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x4d, 0x0a, 0x0e, 0x47,
	0x65, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x1b, 0x2e,
	0x63, 0x68, 0x65, 0x63, 0x6b, 0x6f, 0x75, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x71, 0x1a, 0x1c, 0x2e, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x6f, 0x75, 0x74, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	0x49, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x0b, 0x5a, 0x09, 0x2f, 0x63,
...
var file_checkout_proto_goTypes = []any{
	...
	(*GetPaymentItemReq)(nil),  // 4: checkout.GetPaymentItemReq
	(*GetPaymentItemResp)(nil), // 5: checkout.GetPaymentItemResp
}
var file_checkout_proto_depIdxs = []int32{
	0, // 0: checkout.CheckoutReq.address:type_name -> checkout.Address
	3, // 1: checkout.CheckoutReq.credit_card:type_name -> checkout.CreditCardInfo
	1, // 2: checkout.CheckoutService.Checkout:input_type -> checkout.CheckoutReq
	4, // 3: checkout.CheckoutService.GetPaymentItem:input_type -> checkout.GetPaymentItemReq
	2, // 4: checkout.CheckoutService.Checkout:output_type -> checkout.CheckoutResp
	5, // 5: checkout.CheckoutService.GetPaymentItem:output_type -> checkout.GetPaymentItemResp
