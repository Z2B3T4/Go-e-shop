...
const (
	...
	CheckoutService_GetPaymentItem_FullMethodName = "/checkout.CheckoutService/GetPaymentItem"
)
...
type CheckoutServiceClient interface {
	...
	GetPaymentItem(ctx context.Context, in *GetPaymentItemReq, opts ...grpc.CallOption) (*GetPaymentItemResp, error)
}
...
func (c *checkoutServiceClient) GetPaymentItem(ctx context.Context, in *GetPaymentItemReq, opts ...grpc.CallOption) (*GetPaymentItemResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPaymentItemResp)
	err := c.cc.Invoke(ctx, CheckoutService_GetPaymentItem_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CheckoutServiceServer interface {
	...
	GetPaymentItem(context.Context, *GetPaymentItemReq) (*GetPaymentItemResp, error)
...
func (UnimplementedCheckoutServiceServer) GetPaymentItem(context.Context, *GetPaymentItemReq) (*GetPaymentItemResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPaymentItem not implemented")
}
...
func _CheckoutService_GetPaymentItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPaymentItemReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CheckoutServiceServer).GetPaymentItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CheckoutService_GetPaymentItem_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckoutServiceServer).GetPaymentItem(ctx, req.(*GetPaymentItemReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CheckoutService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPaymentItem",
			Handler:    _CheckoutService_GetPaymentItem_Handler,
		},
	},
