...
import (
	...
	_ "project1/User/http/docs"
	"project1/User/http/routes"
)
...
func main() {
	...
	// 启动加载配置和监听
	nacosManager.Start("userhttp.env")
	// 加载环境变量
	err := godotenv.Load("./userhttp.env")
	if err != nil {
	...
	*/
	...
	url := swagger.URL("http://localhost:8000/swagger/index.html")
